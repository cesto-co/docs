...
Use them anywhere you would normally hand-build a "tracker" or "card" component, like newsletters, partner sites, landing pages, and dashboards. The plugin handles data, animations, and routing to invest. It ships in Cesto's theme out of the box, and you can [restyle it to match your site](/plugins/usage#theming) if you want. You just decide where it sits and how wide it should be.
