...
| Rebalance a position (full loop) | `pnpm rebalance --yes` | [Rebalance a Position](/sdk/rebalance-position) |
...
<Warning>
  The open / close / rebalance / split-flow examples execute **real swaps on Solana mainnet** from the
